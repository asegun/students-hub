...
var Welcomescreen = function (slides, options) {
  ...
  function compileTemplate() {
    ...
    if (options.closeButton) $('<div class="welcomescreen-closebtn "><a href="index001" style="text-decoration:none; color:white;">' + options.closeButtonText + '</a></div>').appendTo($welcomescreenContainer);
